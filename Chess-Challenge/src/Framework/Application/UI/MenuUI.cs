...
namespace ChessChallenge.Application
{
    public static class MenuUI
    {
        public static void DrawButtons(ChallengeController controller)
        {
            ...
            { 
                controller.StartNewBotMatch(ChallengeController.PlayerType.MyBot, ChallengeController.PlayerType.OtherBot); 
            }

            // Page buttons
            buttonPos = UIHelper.Scale(new Vector2(260, 210));
            buttonSize = UIHelper.Scale(new Vector2(260, 55));
            buttonPos.Y += breakSpacing + 3 * spacing;
